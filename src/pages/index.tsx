...
export default function Home() {
  ...
  const handleDeletePessoa = (index:any) => {
  ...
  return (
    <>
      ...
      <header className="flex h-20 items-center justify-between bg-green-600 p-4 ">
        <Image alt="logo" src={"/nb.svg"} width={200} height={100} />
        <p className="text-xl font-bold text-white">Marcelo</p>
      </header>
      <main className="flex min-h-screen   flex-col items-center bg-gradient-to-b ">
        <div className="w-1/2">
          ...
          <div className="py-10" />
          <div>
            <h3 className="text-xl font-bold">Benefícios:</h3>A cada 10 compras,
            o cliente pode escolher um bride!!
